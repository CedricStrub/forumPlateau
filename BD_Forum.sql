...
-- Listage des données de la table forum.membre : ~5 rows (environ)
INSERT INTO `membre` (`id_membre`, `pseudo`, `email`, `password`, `role`, `dateInscription`) VALUES
	(1, 'cedric', 'cedric@mail.fr', 'ced', 'ADMIN', '2022-12-19 12:51:57'),
	(2, 'gilles', 'gilles@mail.fr', 'gil', 'MEMBRE', '2022-12-21 07:50:26'),
	(9, 'cedriic', 'cedriic@mail.fr', '$2y$10$mXf0ksKL4mmzW5rm7TOof.Bno70qPjgclnLk2xbUFNwlrdT8RRMmO', 'MEMBRE', '2022-12-21 15:43:22'),
	(15, 'machin', 'machin@mail.fr', '$2y$10$fUveDVxHToFJyYdWLBYyKep9wvsd.VjhnwKP.G0YQ3VfIV6y249uW', 'MEMBRE', '2023-01-04 12:41:37'),
	(16, 'ced', '', '$2y$10$6nrS/0QGI8QsCfZaarZXM.TSTvcWhT01YZxnpDcksGj55UL7QKTrK', 'MEMBRE', '2023-01-09 08:33:50');
